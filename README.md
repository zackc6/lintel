...
Week-1 decisions are in [docs/YEAR1.md](docs/YEAR1.md). Why this IR and the Acme walks: [docs/WHY.md](docs/WHY.md). The year-1 executable is [docs/POC.md](docs/POC.md) (control CFG+cost+ADG **and** typed Triton schedule). Not the linear v0 examples; not Cake IR.
...
| [docs/POC.md](docs/POC.md) | Year-1 hard kernel: CFG + cost + ADG + typed L4 |
